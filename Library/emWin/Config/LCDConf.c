...
#define __DEMO_TS_WIDTH__  240
#define __DEMO_TS_HEIGHT__ 320
//
// Color conversion
//
...
*
*/
// Modification in LCD_X_Config function in LCDConf.c
...
void LCD_X_Config(void)
{
    ...
    //
    // Orientation - Modified to handle portrait mode properly
    //
    Config.Orientation = GUI_MIRROR_X;  // For portrait orientation
...
// LCD calibration
//
// Calibrate touch screen - Modified to match our orientation
//
    // For portrait mode, we need to swap the X and Y coordinates
